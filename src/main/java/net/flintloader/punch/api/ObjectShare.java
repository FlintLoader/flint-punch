...
/**
 * Object share for inter-mod communication, obtainable through {@link PunchLoader#getObjectShare}.
 *
...
public interface ObjectShare {
	 ...
	 * <pre>
	 * if (PunchLoader.getInstance().getObjectShare().get("someMod:someValue") instanceof String value) {
	 *   // use value here
	 * }
	 * </pre>
	 *
	 ...
	 * <pre>
	 * if (PunchLoader.getInstance().getObjectShare().get("mymod:fuel") instanceof Consumer{@code<?>} c) {
	 ...
	 * <p>Example use:
	 * <pre>
	 * PunchLoader.getInstance().getObjectShare().whenAvailable("someMod:someValue", (k, v) -> {
