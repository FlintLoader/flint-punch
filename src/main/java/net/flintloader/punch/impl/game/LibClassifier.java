...
import net.flintloader.punch.impl.game.LibClassifier.LibraryType;
...
public final class LibClassifier<L extends Enum<L> & LibraryType> {
	...
	private void processManifestClassPath(LoaderLibrary lib) throws IOException {
		if (lib.path == null || !Files.isRegularFile(lib.path)) return;
