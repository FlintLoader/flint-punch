...
**/
package net.flintloader.punch.launch.common;
 ...
 */
@Deprecated
public class PunchLauncherBase implements PunchLauncher {
	private final net.flintloader.punch.impl.launch.PunchLauncher parent = net.flintloader.punch.impl.launch.PunchLauncherBase.getLauncher();
